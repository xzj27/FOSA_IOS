...
-(void)InitView{
    ...
    self.userNameView = [[UIView alloc]initWithFrame:CGRectMake(5, 120, self.mainWidth-15, 50)];
    ...
    self.passwordView = [[UIView alloc]initWithFrame:CGRectMake(5, 180, self.mainWidth-15, 50)];
    ...
    //记住密码
    self.remember = [[UISwitch alloc]initWithFrame:CGRectMake(5,240, 60, 40)];
    [self.view addSubview:self.remember];
    self.memory = [[UILabel alloc]initWithFrame:CGRectMake(60, 240,120,40)];
    ...
    //忘记密码
    self.forgetpassword = [[UILabel alloc]initWithFrame:CGRectMake(self.mainWidth-80, 410, 120, 40)];
    ...
    //登录按钮
    self.login = [[UIButton alloc]initWithFrame:CGRectMake(10, 290, self.mainWidth-20, 50)];
    ...
    //注册按钮
    self.registbtn = [[UIButton alloc]initWithFrame:CGRectMake(10, 350, self.mainWidth-20, 50)];
    ...
    //注册
    self.regist = [[UILabel alloc]initWithFrame:CGRectMake(10, 410, 120, 40)];
